...
export const businessProjects: BusinessProject[] = [
  {
    ...
    tenant_id: "tenant_clinica_prime",
    owner_id: "owner-clinica-prime",
    nome: "Clínica Prime Digital",
    description: "Projeto empresarial para clínica digital com agenda, serviços e relacionamento.",
    segmento: "Saúde",
    business_dna_id: "clinica",
    template_id: "clinica-premium",
  ...
  },
  {
    ...
    tenant_id: "tenant_rede_local",
    owner_id: "owner-rede-local",
    nome: "Marketplace Local Pro",
    description: "Projeto empresarial para marketplace local com fornecedores, pedidos e operação.",
    segmento: "Serviços Locais",
    business_dna_id: "servicos-locais",
    template_id: "servicos-locais",
