      ...
      <View style={styles.heroTop}>
        <View style={styles.logoRow}>
          <View style={styles.logoMark}>
            <Ionicons name="cube-outline" size={22} color="#dbe8ff" />
          </View>
    ...
    <View style={[styles.loginColumn, compact ? styles.loginColumnCompact : null, mobile ? styles.loginColumnMobile : null]}>
      {mobile ? (
        <View style={styles.mobileBrand}>
          <View style={styles.logoMark}>
            <Ionicons name="cube-outline" size={18} color="#dbe8ff" />
          </View>
      ...
      <LinearGradient colors={["rgba(26, 38, 58, 0.96)", "rgba(13, 20, 34, 0.98)"]} style={[styles.loginCard, mobile ? styles.loginCardMobile : null]}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.optionsRow}>
            ...
            <Pressable onPress={() => Alert.alert("Recuperar senha", "Use o fluxo de recuperação configurado no Supabase para esta conta.")}>
        ...
        <View style={styles.signupBlock}>
          ...
          <Pressable onPress={() => Alert.alert("Criar conta", "A criação de conta SaaS deve seguir o fluxo comercial configurado para a plataforma.")}>
...
const styles = StyleSheet.create({
  ...
  shell: {
    ...
    borderRadius: 16,
    borderWidth: 1,
    borderColor: "rgba(128, 151, 190, 0.22)",
    overflow: "hidden",
    shadowColor: "#1c2d66",
    shadowOpacity: 0.26,
    shadowRadius: 38,
  ...
  logoMark: {
    ...
    alignItems: "center",
    justifyContent: "center",
    backgroundColor: "rgba(53, 89, 255, 0.1)",
  },
  logoText: {
    color: "#ffffff",
    fontSize: 25,
  ...
  kicker: {
    ...
    gap: 8,
    borderRadius: 999,
    backgroundColor: "rgba(108, 78, 255, 0.22)",
  ...
  orbitLine: {
    ...
    borderRadius: 36,
    borderWidth: 1,
    borderColor: "rgba(67, 103, 255, 0.26)",
  ...
  platformBase: {
    ...
    justifyContent: "center",
    borderWidth: 1,
    borderColor: "rgba(72, 203, 255, 0.5)",
    shadowColor: "#37d6ff",
    shadowOpacity: 0.42,
    shadowRadius: 30,
    shadowOffset: { width: 0, height: 18 },
  ...
  platformLayer: {
    ...
    borderRadius: 28,
    borderWidth: 2,
    borderColor: "rgba(68, 218, 255, 0.68)",
  ...
  aiChip: {
    flex: 1,
    borderRadius: 18,
    backgroundColor: "rgba(31, 36, 88, 0.96)",
    alignItems: "center",
    justifyContent: "center",
  },
  aiText: {
  ...
  floatingCard: {
    ...
    borderRadius: 12,
    borderWidth: 1,
    borderColor: "rgba(73, 111, 255, 0.5)",
    backgroundColor: "rgba(12, 24, 58, 0.58)",
    alignItems: "center",
    justifyContent: "center",
  },
  floatingCardLeft: {
  ...
  loginColumn: {
    ...
    borderLeftWidth: 1,
    borderLeftColor: "rgba(128, 151, 190, 0.14)",
  },
  loginColumnCompact: {
    width: 420,
    padding: 24,
  ...
  input: {
    ...
    borderRadius: 8,
    borderWidth: 1,
    borderColor: "rgba(134, 151, 180, 0.34)",
  ...
  featureStrip: {
    borderTopWidth: 1,
    borderTopColor: "rgba(128, 151, 190, 0.18)",
    backgroundColor: "rgba(19, 30, 49, 0.7)",
    flexDirection: "row",
    paddingVertical: 34,
