...
export default function PagamentoFalha() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Pagamento nao aprovado</Text>
      <Text style={styles.description}>
        Nao foi possivel confirmar o pagamento agora. Voce pode tentar novamente no pedido.
      </Text>

      <PressableScale style={styles.button} onPress={tentarNovamente}>
